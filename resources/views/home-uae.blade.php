				...
				<div class="top-features-slide">
					<div class="item">
						<div class="main-content" style="background:#fafafa;">
							...
							<h4><a href="{{ route('ae-tax-technology') }}"><u>T</u>ax
Technology</a></h4>
					...
					<div class="item">
						<div class="main-content" style="background:#f6f6f6;">
							...
							<h4><a href="{{ route('ae-management-service') }}"><u>M</u>anaged Services</a></h4>
					...
					<div class="item">
						<div class="main-content" style="background:#efefef;">
							...
							<h4><a href="{{ route('ae-structuring-tax') }}"><u>S</u>tructuring
Transaction</a></h4>
					...
					<div class="item">
						<div class="main-content" style="background:#e9e9e9;">
							...
							<h4><a href="{{ route('ae-litigation-management') }}">><u>L</u>itigation
Management</a></h4>
