...
<div class="our-team section-spacing">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-12">
                     <div class="team-member">
                        <div class="image-box">
                            <img src="images/team/gcc/5.png" alt="Profile picture of Jigar Doshi">
                            <div class="overlay">
                    ...
                    <div class="text">
                        <h6>Jigar Doshi <br> جيجار دوشي</h6>
                        <p>India & GCC</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                 <div class="team-member">
                    <div class="image-box">
                        <img src="images/team/gcc/6.png" alt="Profile picture of Pratik Shah">
                        <div class="overlay">
                            <div class="hover-content">
                                <ul>
                    ...
                    <div class="text">
                        <h6>Pratik Shah <br> براتيك شاه</h6>
                        <p>India & GCC</p>
                    </div>
    </div>
                </div> <!-- /.col- -->
                <div class="col-lg-4 col-sm-6 col-12">
                   <div class="team-member">
                    <div class="image-box">
                        <img src="images/team/gcc/7.png" alt="Profile picture of Sanket Shah">
                        <div class="overlay">
                            <div class="hover-content">
                                <ul>
                    ...
                    <div class="text">
                        <h6>Sanket Shah <br> سانكيت شاه</h6>
                        <p>India & GCC</p>
                    </div>
    </div>
                </div> <!-- /.col- -->
                <div class="col-lg-4 col-sm-6 col-12">
                 <div class="team-member">
                        <div class="image-box">
                            <img src="images/team/gcc/11.png" alt="Profile picture of Ravi Chitnis">
                            <div class="overlay">
                                <div class="hover-content">
                                    <ul>
                        ...
                        <div class="text">
                            <h6>Ravi Chitnis <br> رافي تشيتنيس</h6>
                            <p>GCC</p>
                        </div>
                    </div>
                </div> <!-- /.col- -->
                ...
                <div class="team-member">
                    ...
                    <div class="text">
                        <h6>Piyush Baid <br> بيوش بايد</h6>
                        <p>GCC</p>
                    </div>
                </div>
                </div> <!-- /.col- -->
               ...
               <div class="team-member">
    <div class="image-box">
        <img src="images/team/gcc/10.jpg" alt="Profile picture of Jinesh Baid">
        <div class="overlay">
            <div class="hover-content">
                <ul>
    ...
    <div class="text">
        <h6>Jinesh Baid <br> جينيش بايد</h6>
        <p>GCC</p>
    </div>
</div>
                </div> <!-- /.col- -->
